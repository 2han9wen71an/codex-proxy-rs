    ...
    async fn replace_runtime_settings(
        ...
        let replacement = postgres::ControlPlaneReplacement {
            settings: postgres::RuntimeSettingsUpdate {
                ...
                codex_session_affinity_enabled: command.codex_session_affinity_enabled,
                round_robin_cross_weight_enabled: command.round_robin_cross_weight_enabled,
            ...
            audit: mutation_audit(
                ...
                vec![
                    ...
                    "codex_session_affinity_enabled".to_owned(),
                    "round_robin_cross_weight_enabled".to_owned(),
...
pub(crate) fn admin_runtime_settings(
    ...
    Ok(AdminRuntimeSettings {
        ...
        round_robin_cross_weight_enabled: settings.round_robin_cross_weight_enabled,
